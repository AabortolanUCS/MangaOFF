...
public class SearchAdapter extends RecyclerView.Adapter<HomeListAdapter.ViewHolder> {
    private final List<ResponseMangasData> localDataSet;
    private final Activity activity;
    private final SearchViewModel viewModel;

    public SearchAdapter(List<ResponseMangasData> dataSet, Activity activity, SearchViewModel viewModel) {
